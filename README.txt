...
Deka_embedding.ipynb: every detail about the numerical_model
                      from data cleaning to model building
                      
DEKA_TFIDF.ipynb: contains the every detail about the description_model
